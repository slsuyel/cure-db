...
import { transformSidebarData } from '../../utils/transformSidebarData';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const sidebarData: TUserPath[] = transformSidebarData(adminPaths);
  ...
  return (
    ...
    >
      {/* SIDEBAR HEADER */}
      <div className="flex items-center justify-between gap-2 px-6 py-2 pt-5.5 lg:pt-6.5">
